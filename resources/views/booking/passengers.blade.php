            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form action="{{ route('booking.passengers.store', $booking) }}" method="POST">
                        ...
                        <!-- Contact Information -->
                        <div class="mb-8">
                            <h3 class="text-lg font-semibold mb-4 dark:text-white">Contact Information</h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="email" name="contact_email" value="{{ old('contact_email', auth()->user()->email) }}" required readonly
                                        class="w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 bg-gray-100 dark:bg-gray-600 dark:text-white">
                                    @error('contact_email')
                                        <p class="text-red-500 dark:text-red-400 text-sm mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <!-- Passengers -->
                        <div class="mb-8">
                            <h3 class="text-lg font-semibold mb-4 dark:text-white">Passenger Information</h3>
                            @for ($i = 0; $i < $booking->seat_count; $i++)
                                <div class="mb-6 p-4 border dark:border-gray-600 rounded-lg">
                                    <h4 class="font-semibold mb-4 dark:text-white">Passenger {{ $i + 1 }}</h4>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                        ...
                                        <div class="md:col-span-2">
                                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Nationality (ISO Code) *</label>
                        ...
                        <div class="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            <h3 class="font-semibold mb-2 dark:text-white">Booking Summary</h3>
                            ...
                            <div class="flex justify-between font-bold text-lg mt-2 dark:text-white">
                                <span>Total:</span>
