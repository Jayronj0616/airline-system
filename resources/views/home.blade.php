<x-public-layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white rounded-lg shadow-sm p-8 text-center">
                    ...
                    <div class="text-4xl font-bold text-gray-900 mb-2">{{ $upcomingFlights }}</div>
                    <div class="text-gray-600">Upcoming Flights</div>
                </div>
                <div class="bg-white rounded-lg shadow-sm p-8 text-center">
                    <div class="text-green-600 text-5xl mb-4">🌍</div>
                    <div class="text-4xl font-bold text-gray-900 mb-2">{{ $availableDestinations }}</div>
                    <div class="text-gray-600">Destinations</div>
                </div>
                <div class="bg-white rounded-lg shadow-sm p-8 text-center">
                    <div class="text-purple-600 text-5xl mb-4">💰</div>
                    <div class="text-4xl font-bold text-gray-900 mb-2">Live</div>
                    <div class="text-gray-600">Dynamic Pricing</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600">Most booked destinations this month</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                @foreach($popularRoutes as $route)
                    <a href="{{ route('flights.search', ['origin' => $route->origin, 'destination' => $route->destination]) }}" 
                       class="block bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl shadow-sm hover:shadow-lg transition p-6 border-2 border-transparent hover:border-blue-500">
                        <div class="flex justify-between items-start mb-4">
                            <div>
                                <h3 class="text-2xl font-bold text-gray-900">{{ $route->origin }} → {{ $route->destination }}</h3>
                                <p class="text-gray-600 text-sm mt-1">{{ $route->total_passengers }} passengers</p>
                            </div>
                            <div class="bg-white rounded-lg px-3 py-1 text-sm font-semibold text-blue-600">
                        ...
                        <div class="flex justify-between items-end">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-blue-600">${{ number_format($route->min_price, 0) }}</p>
                            </div>
    ...
    <div class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">📈 Trending Searches</h2>
                <p class="text-gray-600">Where travelers are looking to go</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                @foreach($trendingSearches as $search)
                    <a href="{{ route('flights.search', ['origin' => $search->origin, 'destination' => $search->destination]) }}" 
                       class="block bg-white rounded-xl shadow-sm hover:shadow-lg transition p-6 border-2 border-transparent hover:border-green-500">
    ...
    <div class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">Why Book With Us?</h2>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-bold mb-2">Dynamic Pricing</h3>
                    <p class="text-gray-600">Real-time pricing based on demand, availability, and departure time</p>
                </div>
                <div class="text-center">
                    ...
                    <p class="text-gray-600">Get your booking confirmed instantly with email notifications</p>
                </div>
                <div class="text-center">
                    ...
                    <p class="text-gray-600">Manage bookings, check-in online, and track flight status easily</p>
                </div>
            </div>
        </div>
    </div>
